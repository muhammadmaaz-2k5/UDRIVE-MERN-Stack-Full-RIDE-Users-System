-- 0. Create custom Clerk auth.uid() equivalent first so policies can use it
...
-- 1. Drop ALL existing policies before altering columns
...
-- 5. Recreate RLS Policies with clerk_user_id()
-- Profiles
